...
import com.example.adminquotesapp.Adapters.ContactAdapter;
...
//                });
    ...
    private void showUpdateDialog(final String id, final String num1, final String num2, final String email, final String website, String address) {
